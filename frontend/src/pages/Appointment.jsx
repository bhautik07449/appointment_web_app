        ...
        <div>
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex-1 border border-[#ADADAD] rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
                    ...
                    {/* ----- Doc About ----- */}
                    <div>
                        <p className='flex items-center gap-1 text-[20px] font-medium text-[#262626] mt-3'>About <img className='w-3' src={assets.info_icon} alt="" /></p>
                        <p className='text-sm text-gray-600 max-w-[700px] mt-1 text-[14px]'>{docInfo.about}</p>
                    </div>
